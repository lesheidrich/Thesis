...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|>{\raggedright\arraybackslash}p{10cm}|}
		...
		\hline
		PR1 & Client & Application should be compatible with Windows 10 (or later) operating systems. \\
		\hline
		PR2 & Client & Operating system is required to have .Net Framework 4.0.3 (or later). \\
		\hline
		PR3 & Host & Server environment must be capable of running a Python application with a Flask framework. \\
		\hline
		PR4 & Requirements & A full list of back end application requirements are available at: \url{https://github.com/lesheidrich/WebScraping_and_MCSim/blob/master/requirements.txt}. \\
		\hline
		PR5 & Database & The database server must be either XAMPP or MySQL compatible. \\
		\hline
	\end{tabular}
