...
\begin{itemize}
	...
	This is representative of a players playtime in a real life scenario, where third-string players will generally not see a lot of playtime unless the match itself is a statistical outlier. This can mean either injury, or the team performing so well or so poorly, that novice players can be introduced without detrimentally affecting the outcome of the match.\footnote{To reiterate, this logic comes arbitrarily from my personal views pertaining to the game of basketball and its analytics. There are certainly more appropriate ways of calculating player utilization. However, they are complex in nature and require lengthy study and testing. As this project approaches the subject matter from an introductory computer science perspective at the BSc level, this method's results should be satisfactory.}
